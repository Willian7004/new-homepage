...
with st.expander("YuE音乐集 （展开项目说明）"):
    st.write("本项目内容为本人使用YuE生成的音乐。通过sgsdxzy/YuE-exllamav2项目进行部署，stage1模型使用4.25bpw版本，stage2模型使用8.0bpw版本，显存门槛约为6g。提示词使用Qwq 32b创建，其中风格提示词使用官方的说明、参考词汇和示例作为提示词进行创建，歌词根据风格提示词、官方说明和示例创建。歌词不使用连续两次换行，在这里为了能正常显示换行进行了转换。")
# 获取音乐文件夹路径
