...
st.write("Images by Hunyuan Video项目，展示使用Hunyuan Video生成的图片，复用了以前使用Flux.1的提示词并添加了一些新的内容，位于gallery1页面")
...
st.write("Wan2.1 Video Gallery项目，展示使用Wan2.1 1.3b生成的视频，复用了之前使用其它模型生成的发布在社交平台的视频的提示词并添加了一些新的内容，位于gallery2页面")
