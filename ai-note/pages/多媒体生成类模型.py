...
st.write("视频模型分为高成本和低成本路线。高成本路线闭源模型包括Veo2和可灵等，开源模型包括Step Video和Wan2.1（Hunyuan Video在同成本下效果较差），有出片率和文生视频稳定的优势，生成效果也更好。低成本路线闭源模型包括PixVerse v4，开源模型包括Cosmos，运动物体效果差一些并且文生视频画质低。另外Vidu2.0和Pika2.0属于中等成本，功能完善且可能有较高性价比。")
