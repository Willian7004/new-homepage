...
st.subheader("5.最美桌面环境", divider=True)
...
st.write("当前版本的Budgie桌面环境用了不少阴影效果（任务栏阴影需要开启内置主题），再加上图标设计，可以算是一个借鉴了Material Design理念并做到相近水平的全新方案，个人认为在Linux中算是最佳设计了。不过功能方面，由于文本编辑器等程序折叠了菜单，功能性不如Cinnamon桌面环境。另外也有不支持非整数缩放和只有左右分屏的功能缺陷。")
