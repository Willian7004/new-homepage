...
st.write("当前版本的Budgie桌面环境用了不少阴影效果（任务栏阴影需要开启内置主题），再加上图标设计，算是Linux上最好的Material Design方案，个人认为在Linux中也是外观最好的设计。另一个优势是比较轻量化，流畅度明显优于Cinnamon，算是在j1800唯一达到可用水平的又动画的桌面环境，n5095以上配置应该能达到比较高的流畅度。不过功能方面，由于文本编辑器等程序折叠了菜单，功能性不如Cinnamon桌面环境。另外也有不支持非整数缩放和只有左右分屏的功能缺陷。")
