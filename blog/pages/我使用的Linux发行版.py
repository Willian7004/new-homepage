...
st.write("在主力机使用时，考虑到2.5k屏幕使用无非整倍缩放桌面环境的效果较差，就继续使用Linux Mint。更换主题时发现部分Cinnamon主题有窗口主题，具有较好的外观表现，就检查了所有主题，表现较好的有以下四个")
st.image("blog/files/CT1.jpg")
st.image("blog/files/CT2.jpg")
