...
st.image("blog/files/wukong.jpg")
...
st.image("blog/files/UE5_1.jpg")
st.image("blog/files/UE5_2.jpg")
st.image("blog/files/UE5_3.jpg")
...
st.image("blog/files/epyc7002.jpeg")
...
st.write("低功耗处理器分为多个系列，英特尔有几个功耗10w左右的系列，其中凌动X系列有新产品；n系列推出较晚，为大小核架构中的全小核处理器，存在核间延时等问题；赛扬j系列已停产。使用这一级别处理器的产品包括瘦客户机、x86平板电脑和电脑棒等，有不少成品二手硬件可选。另外也有与标压处理器同核心的低压版本，包括英特尔p系列以及AMD的u版本，功耗15到28w。")
...
st.image("blog/files/AMD8050.jpeg")
