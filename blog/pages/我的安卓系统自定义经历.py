...
with col1:
    st.subheader("通知栏1")
    st.image("blog/files/iconify_1.jpg")
with col2:
    st.subheader("快速设置面板1")
    st.image("blog/files/iconify_2.jpg")
with col3:
    st.subheader("设置图标1")
    st.image("blog/files/iconify_3.jpg")
col4, col5, col6 = st.columns(3)
with col4:
    st.subheader("通知栏2")
    st.image("blog/files/iconify_4.jpg")
with col5:
    st.subheader("快速设置面板2")
    st.image("blog/files/iconify_5.jpg")
with col6:
    st.subheader("设置图标2")
    st.image("blog/files/iconify_6.jpg")
